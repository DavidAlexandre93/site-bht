...
const NewsletterSection = () => {
  ...
  const mailchimpActionUrl = "https://bloodhuntsgaming.us18.list-manage.com/subscribe/post?u=d6a36bd136079ed9f553d652e&id=2bc7833269";
  ...
  return (
    <section className="newsletter-section">
      ...
      <form action={mailchimpActionUrl} method="POST" noValidate className="newsletter-section__right">
        ...
        <p>Informe seu email para receber informações sobre nossa organização e noticias.</p>
